...
public class RecipeEndpoint {
	...
	public Response create(Recipe entity) {
		em.persist(entity);
		return Response.created(
				UriBuilder.fromResource(RecipeEndpoint.class)
						.path(String.valueOf(entity.getRecipeId())).build())
				.build();
	}
	...
	public List<Recipe> listAll(@QueryParam("start") Integer startPosition,
		...
		final List<Recipe> results = findAllQuery.getResultList();
		return results;
	}
	...
	@Path("/{id:[0-9][0-9]*}")
	@Consumes("application/json")
	public Response update(@PathParam("id") int id, Recipe entity) {
		if (entity == null) {
			return Response.status(Status.BAD_REQUEST).build();
		}
		if (id != entity.getRecipeId()) {
