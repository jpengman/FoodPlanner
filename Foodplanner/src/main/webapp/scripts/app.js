...
angular.module('foodplanner',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/TestTables',{templateUrl:'views/TestTable/search.html',controller:'SearchTestTableController'})
      .when('/TestTables/new',{templateUrl:'views/TestTable/detail.html',controller:'NewTestTableController'})
      .when('/TestTables/edit/:TestTableId',{templateUrl:'views/TestTable/detail.html',controller:'EditTestTableController'})
